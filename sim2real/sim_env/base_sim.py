...
class BaseSimulator:
    def __init__(self, config):
        ...
        self.force_start_time = 18.0  # 18秒后施加力
        self.force_duration = 0.05  # 20.0  # 0.05 # 持续20秒
    ...
    def sim_step(self):
        ...
        # 只在仿真时间大于15秒后施加力
        if  self.mj_data.time <= self.force_start_time <= self.mj_data.time + self.force_duration and ADD_FORCE:
